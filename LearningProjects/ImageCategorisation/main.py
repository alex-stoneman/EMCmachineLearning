...
import numpy as np
import os
#thing = np.load("imageTensors.npy")
# print(thing.shape)
# print(thing[0].shape)
...
# print(train_images.shape) # Create a tensor for A images of B by C pixels of shape (A, B, C)
# print(test_images.shape)
# print(train_labels.shape) # Create a tensor of A labels
...
#checkpoint_path = f"Model_{number}/cp.ckpt"
